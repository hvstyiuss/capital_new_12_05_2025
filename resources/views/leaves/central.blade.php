...
@section('title', 'Demandes Centrales')
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('hr.leaves.central') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    @if(request('statut') || request('year'))
                        <a href="{{ route('hr.leaves.central') }}" class="btn btn-sm btn-outline-primary mt-3">

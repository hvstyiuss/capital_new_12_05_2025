...
@section('title', 'Avis de Départ - PDF avec Solde')
...
<div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-1 fw-bold text-dark">
                    ...
                    Avis de Départ - PDF avec Solde
                </h1>
                <p class="text-muted mb-0">Visualisation de l'avis de départ avec les informations de solde</p>
            </div>
            <div>
                ...
                @if($pdfUrl)
                <a href="{{ route('hr.leaves.download-avis-depart-pdf', $avisDepart->id) }}" class="btn btn-danger" target="_blank">
    ...
    <!-- Avis de Départ Information -->
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-bottom py-3">
            <h5 class="mb-0 fw-bold">
                <i class="fas fa-info-circle text-primary me-2"></i>
                Informations de l'Avis de Départ
            </h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="text-muted small d-block mb-1">Date de Retour Prévue</label>
                        <p class="fw-bold mb-0">{{ $avisDepart->date_retour ? \Carbon\Carbon::parse($avisDepart->date_retour)->format('d/m/Y') : 'N/A' }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="text-muted small d-block mb-1">Nombre de Jours Demandés</label>
                        <p class="fw-bold mb-0">{{ $avisDepart->nb_jours_demandes ?? 0 }} jour(s)</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="text-muted small d-block mb-1">Date de Dépôt</label>
                        <p class="fw-bold mb-0">{{ $avisDepart->created_at->format('d/m/Y à H:i') }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
        ...
        <div class="card-body p-0">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted small">Le PDF sera généré automatiquement après validation de l'avis de départ.</p>
                </div>
            @endif
        </div>
    </div>

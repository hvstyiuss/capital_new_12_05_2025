...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 text-lg mt-2">Créez une nouvelle essence pour votre système</p>
            </div>
        </div>
    </div>
    ...
    <!-- Create Form -->
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-gray-700/20">
        <div class="flex items-center gap-4 mb-6">
            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-teal-600 rounded-xl flex items-center justify-center">
                <i class="fas fa-plus text-white text-xl"></i>
            </div>
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Formulaire de création</h2>
                <p class="text-gray-600 dark:text-gray-400">Remplissez les informations pour créer une nouvelle essence</p>
            </div>
        </div>
        ...
        <form action="{{ route('settings.essences.store') }}" method="POST" class="space-y-6" data-server-validation>
            ...
            <div class="form-group">
                <label for="essence" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 mt-8 border border-blue-200 shadow-xl">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h3 class="text-2xl font-bold text-blue-900">À propos des Essences</h3>
                <p class="text-blue-700">Informations importantes sur la création d'essences</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-blue-200">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Chaque essence doit avoir un nom unique dans le système</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-blue-200">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Les essences sont utilisées dans les articles et rapports</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-bold text-gray-900">Importer des Essences</h3>
            ...
            <form action="{{ route('settings.essences.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
                    ...
                    <ul class="text-xs text-blue-700 space-y-1">
                        <li>• Colonne A : Nom de l'essence (obligatoire)</li>

...
@section('title', 'Modifier le Type d\'Annonce')
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-2">Modifiez les informations du type {{ $typeAnnonce->nom }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600">Mettez à jour les informations du type d'annonce</p>
            </div>
        </div>
        <form action="{{ route('type-annonces.update', $typeAnnonce) }}" method="POST" class="space-y-8" novalidate autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-200">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" 
                           ...
                           id="nom" name="nom" value="{{ old('nom', $typeAnnonce->nom) }}" 
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea 
                        ...
                        placeholder="Description du type d'annonce...">{{ old('description', $typeAnnonce->description) }}</textarea>
                    @error('description')
                        <div class="text-red-500 text-sm mt-1 flex items-center gap-2 validation-error">
                            <i class="fas fa-exclamation-circle"></i>
                            {{ $message }}
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" 
                               ...
                               id="couleur" name="couleur" value="{{ old('couleur', $typeAnnonce->couleur ?: '#ff6b35') }}">
                        <input type="text" 
                               ...
                               id="couleur_text" 
                               value="{{ old('couleur', $typeAnnonce->couleur ?: '#ff6b35') }}"
                               placeholder="#ff6b35"
                               pattern="^#[0-9A-Fa-f]{6}$">
                    </div>
                    @error('couleur')
                ...
                <div class="form-group">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" 
                               name="is_active" 
                               value="1"
                               {{ old('is_active', $typeAnnonce->is_active) ? 'checked' : '' }}

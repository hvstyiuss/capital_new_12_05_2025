...
@section('title', 'Volume par Forêt')
...
<div class="content-card">
    ...
    <div class="header-content">
        <div>
            <h1 class="card-title">Volume par Forêt</h1>
            <p class="card-subtitle">Analysez les volumes par forêt avec des statistiques détaillées</p>
        </div>
    ...
    <div class="filters-form">
        <form method="GET" action="{{ route('reports.articles-by-foret') }}" class="filters-grid">
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('reports.articles-by-foret') }}" class="btn btn-outline-secondary">

...
@section('title', 'Articles Historiques par Essence - Rapports')
...
<div class="container mx-auto px-4 py-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                            Articles par Essence
                        </h1>
                        <p class="text-gray-600 text-lg mt-2">Analysez les articles historiques par essence forestière</p>
                    </div>
                </div>
    ...
    <div class="mb-8">
        <x-card 
            title="Filtres" 
            subtitle="Filtrez les articles par essence"
            variant="colored"
            color="purple"
            icon="fas fa-filter"
            padding="compact"
        >
            <form method="GET" action="{{ route('reports.legacy-articles-by-essence') }}" class="flex flex-col md:flex-row gap-4 items-end">
                <div class="flex-1">
                    <label for="essence" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-leaf text-purple-500 mr-2"></i>
                        Essence
                    </label>
                    <select 
                        id="essence" 
                    ...
                    >
                        ...
                        @foreach($essences as $essenceOption)
                            <option value="{{ $essenceOption->essence }}" {{ $essence == $essenceOption->essence ? 'selected' : '' }}>
                                {{ $essenceOption->essence }}
                            </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="flex gap-2">
                    ...
                    <a 
                        href="{{ route('reports.legacy-articles-by-essence') }}" 
    ...
    <x-card 
        ...
        subtitle="Liste des articles historiques{{ $essence ? ' pour l\'essence ' . $essence : '' }}"
        variant="gradient"
        color="purple"
        icon="fas fa-table"
    >
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                            Aucun article trouvé{{ $essence ? ' pour l\'essence ' . $essence : '' }}.
                        </td>
                    </tr>
                    @endforelse
                </tbody>

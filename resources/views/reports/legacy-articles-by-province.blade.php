...
@section('title', 'Articles Historiques par Province - Rapports')
...
<div class="container mx-auto px-4 py-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                            Articles par Province
                        </h1>
                        <p class="text-gray-600 text-lg mt-2">Analysez les articles historiques par province</p>
                    </div>
                </div>
    ...
    <div class="mb-8">
        <x-card 
            title="Filtres" 
            subtitle="Filtrez les articles par province"
            variant="colored"
            color="green"
            icon="fas fa-filter"
            padding="compact"
        >
            <form method="GET" action="{{ route('reports.legacy-articles-by-province') }}" class="flex flex-col md:flex-row gap-4 items-end">
                <div class="flex-1">
                    ...
                    >
                        ...
                        @foreach($provinces as $provinceOption)
                            <option value="{{ $provinceOption->province }}" {{ $province == $provinceOption->province ? 'selected' : '' }}>
                ...
                <div class="flex gap-2">
                    ...
                    <a 
                        href="{{ route('reports.legacy-articles-by-province') }}" 
    ...
    <x-card 
        ...
        subtitle="Liste des articles historiques{{ $province ? ' pour la province ' . $province : '' }}"
        variant="gradient"
        color="green"
        icon="fas fa-table"
    >
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                            Aucun article trouvé{{ $province ? ' pour la province ' . $province : '' }}.
                        </td>
                    </tr>
                    @endforelse
                </tbody>

...
@section('title', 'Modèle de demande d\'intégration à l\'ANEF')
        ...
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-4xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
                    Modèle de demande d'intégration à l'ANEF
                </h1>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 border border-white/20">
        @if($pdfExists)
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ $pdfUrl }}" 
                   download 
                   class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-300">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">Le fichier PDF "Modèle de demande d'intégration à l'ANEF" n'est pas encore disponible.</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-gray-700">
                                Veuillez contacter l'administrateur pour obtenir ce document ou vérifier que le fichier <strong>demande_integration.pdf</strong> a été ajouté dans le dossier <strong>public/edocuments/</strong>.
                            </p>
                        </div>
                    </div>
                </div>

    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 border border-white/20">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">Le fichier PDF "Loi N°52.20" n'est pas encore disponible.</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-gray-700">
                                Veuillez contacter l'administrateur pour obtenir ce document ou vérifier que le fichier <strong>loi_52_20.pdf</strong> a été ajouté dans le dossier <strong>public/edocuments/</strong>.
                            </p>
                        </div>
                    </div>
                </div>
